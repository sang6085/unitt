...
import { getByIdEmailTemplates, insertEmailTemplate, updateEmailTemplate } from "../../services/EmailTemplateService";
  ...
  React.useEffect(() => {
    function getData() {
      if (location.pathname.slice(1).split("/")[2]) {
        ...
        getByIdEmailTemplates({ id: Number(location.pathname.slice(1).split("/")[2]) }).subscribe((response: any) => {
                ...
                <React.Fragment>
                  ...
                  <Grid item xs={6}>
                    <ButtonGroup disableElevation variant="contained">
                      <Button variant={active ? "contained" : "outlined"} onClick={() => setActive(1)}>
                        {t("emailTemplates.active")}
                      </Button>
                      <Button variant={!active ? "contained" : "outlined"} onClick={() => setActive(0)}>
