...
import DialogAlert from "../../components/Alert/Notification";
...
const Employee: React.FC = () => {
        ...
        customBodyRender: (value: any, tableIndex: any) => {
          return (
            ...
            >
              ...
              ></Box>
              {tableIndex?.tableData[tableIndex.rowIndex][4]?.office[0].name}
            </Box>
          );
        },
      },
  ...
  return (
    <Box className="content">
      {/* <Button onClick={() => console.log(dataEmployee)}>aaaa</Button> */}
      <Box sx={{ px: 3, mb: 3 }}>
        <Typography variant="h5" sx={{ fontWeight: "bold" }}>
          {t(`employee.employyepaccount`)}
        </Typography>
      </Box>
      <Box sx={{ p: 3 }}>{/* <DropZone setFilesChoose={setFiles}/> */}</Box>
      <Box sx={{ px: 3 }}>
        <Paper elevation={3}>
        ...
        <MUIDataTable
          title=""
          columns={mainColumns}
          data={dataEmployee !== undefined && dataEmployee}
          options={options}
        />
      </Box>
      <DialogAlert
